  ...
  useEffect(() => {
    const fetchRanking = async () => {
      try {
        ...
        console.log("Resposta completa do ranking:", data);
  ...
  return (
    <div className="ranking-page">
      <div className="ranking-header">
        <h1 translate="no">Hall da Fama</h1>
          ...
          return (
            ...
            >
              ...
              <div className="rank-details">
                <span className="rank-name">{isUser ? "Você" : aluno.nome}</span>
